...
export const fetchCategories = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get('http://www.api.mhbstore.com/api/categories');
...
export const fetchCategoryById = createAsyncThunk(
  ...
  async (categoryId) => {
    const response = await axios.get(`http://www.api.mhbstore.com/api/categories/${categoryId}`);
