...
export const fetchSubCategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get('http://www.api.mhbstore.com/api/subcategory'); // Ensure the API endpoint is correct
...
export const fetchSubCategoryById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const response = await axios.get(`http://www.api.mhbstore.com/api/subcategory/${id}`);
...
export const addSubCategory = createAsyncThunk(
  ...
  async (subCategoryData, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://www.api.mhbstore.com/api/subcategory', subCategoryData, {
...
export const deleteSubCategory = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await axios.delete(`http://www.api.mhbstore.com/api/subcategory/${id}`);
      return id;
    } catch (error) {
      console.error(error);
      return rejectWithValue(error.message);
...
export const updateSubCategory = createAsyncThunk(
  ...
  async ({ id, updatedData }, { rejectWithValue }) => {
    try {
      const response = await axios.patch(`http://www.api.mhbstore.com/api/subcategory/${id}`, updatedData, {
        headers: { 'Content-Type': 'application/json' },
      });
      if (response.data && response.data.data) {
        return response.data.data;
