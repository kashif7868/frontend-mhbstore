...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (accessToken && !user) {
      axios
        .post("http://www.api.mhbstore.com/api/auth/refresh", { token: refreshToken })
        .then((response) => {
  ...
  const signUp = async (userData) => {
    try {
      const response = await axios.post(
        "http://www.api.mhbstore.com/api/auth/",
        userData
      );
      const { user, tokens } = response.data;
  ...
  const login = async ({ email, password }) => {
    try {
      const response = await axios.post(
        "http://www.api.mhbstore.com/api/auth/login",
        {
          email,
          password,
        }
  ...
  const logout = async () => {
    try {
      await axios.post(
        "http://www.api.mhbstore.com/api/auth/logout",
  ...
  const forgotPassword = async (email) => {
    try {
      await axios.post("http://www.api.mhbstore.com/api/auth/forgot-password", {
        email,
      });
  ...
  const resetPassword = async (resetPasswordToken, newPassword) => {
    try {
      await axios.post(
        "http://www.api.mhbstore.com/api/auth/reset-password",
        {
          resetPasswordToken,
          newPassword,
        }
  ...
  const getUserById = async (userId) => {
    try {
      const { data } = await axios.get(
        `http://www.api.mhbstore.com/api/auth/users/${userId}`,
        {
          headers: {
